...
public class InMemoryRepository implements MarsRepositories{
    ...
    public InMemoryRepository(){
        ...
        transporters.put("TT-1", new Transporter("TT-1", "TT-1", new Size(10f, 10f, 10f), new Building(TypeOfLocation.RESIDENCE, new Coordinates(1f, 1f)), "http://t1.shippert.thiboverbeerst.com/"));
        transporters.put("TT-2", new Transporter("TT-2","TT-2", new Size(10f, 10f, 10f), new Building(TypeOfLocation.RESIDENCE, new Coordinates(1f, 1f)), "http://t5.shippert.thiboverbeerst.com/"));
        transporters.put("TT-3", new Transporter("TT-3","TT-3", new Size(10f, 10f, 10f), new Building(TypeOfLocation.RESIDENCE, new Coordinates(1f, 1f)), "https://t7.shippert.thiboverbeerst.com/"));
