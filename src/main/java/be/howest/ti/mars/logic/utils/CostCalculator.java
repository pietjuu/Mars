 ...
 *
 * <p></p><sup>x</sup>(&radic (y * p)<sup>z</sup>) / 10<sup>9</sup> x 50000 x 30</p>
 *
 * In this case it would be:
 *
 * <p></p><sup>3</sup>(&radic (8 * 2)<sup>2</sup>) / 10<sup>9</sup> x 50000 x 30</p>
...
public class CostCalculator {
    ...
    public static double calculateCostOfMol(String molecule){
        ...
        return Math.pow(Math.pow((y*p), z), 1f/x) / Math.pow(10, 9) * 50000 * 3;
    }
