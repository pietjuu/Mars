...
!function (e) {
    ...
    var a = function (e, n) {
        ...
        var o = function () {
            s.sockJSConn = new t(e, null, n), s.state = a.CONNECTING, s.handlers = {}, s.replyHandlers = {}, s.sockJSConn.onopen = function () {
                ...
                var n, t, r;
                s.state = a.CLOSED, s.pingTimerID && clearInterval(s.pingTimerID), s.reconnectEnabled && s.reconnectAttempts < s.maxReconnectAttempts && (s.sockJSConn = null, s.reconnectTimerID = setTimeout(o, (r = s.reconnectDelayMin * Math.pow(s.reconnectExponent, s.reconnectAttempts), s.randomizationFactor && (n = Math.random(), t = Math.floor(n * s.randomizationFactor * r), r = 0 == (1 & Math.floor(10 * n)) ? r - t : r + t), 0 | Math.min(r, s.reconnectDelayMax))), ++s.reconnectAttempts), s.onclose && s.onclose(e)
    ...
    if (a.prototype.send = function (e, n, t, r) {
        ...
        var o, s = {type: "send", address: e, headers: i(this.defaultHeaders, t), body: n};
        r && (o = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (e, n) {
            return n = 16 * Math.random(), ("y" == e ? 3 & n | 8 : 0 | n).toString(16)
        }), s.replyAddress = o, this.replyHandlers[o] = r), this.sockJSConn.send(JSON.stringify(s))
        ...
        if (this.state != a.OPEN) throw new Error("INVALID_STATE_ERR");
        var r, o = this.handlers[e];
        o && ("function" == typeof n && (t = n, n = {}), -1 != (r = o.indexOf(t)) && (o.splice(r, 1), 0 === o.length && (this.sockJSConn.send(JSON.stringify({
            type: "unregister",
            address: e,
            headers: i(this.defaultHeaders, n)
        ...
        }, 0 < t.pingInterval && (n(), t.pingTimerID = setInterval(n, t.pingInterval))) : t.pingTimerID && (clearInterval(t.pingTimerID), t.pingTimerID = null)
